...
local function createControlPanel()
    ...
    title.Text = "🎯 AUTO-FARM CONTAINERS"
    ...
    pickupToggle.Text = "⚡ Auto-selection: OFF"
    ...
    priorityToggle.Text = "🎯 Priority farming: ON"
    ...
    teleportToggle.MouseButton1Click:Connect(function()
        ...
        teleportToggle.Text = "🚀 Auto-teleport: " .. (settings.autoTeleport and "ON" or "OFF")
    ...
    pickupToggle.MouseButton1Click:Connect(function()
        ...
        pickupToggle.Text = "⚡ Auto-selection: " .. (settings.autoPickup and "ON" or "OFF")
    ...
    priorityToggle.MouseButton1Click:Connect(function()
        ...
        priorityToggle.Text = "🎯 Priority farming: " .. (settings.priorityFarm and "ON" or "OFF")
    ...
    heightSlider.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1 then
            ...
            connection = RunService.Heartbeat:Connect(function()
                ...
                heightLabel.Text = "Teleportation Height: " .. settings.teleportHeight .. " studs"
...
local function pickupContainer(container)
    ...
    if prompt then
        ...
        if success then
            print("✅ Proximity prompt activated: " .. container.Name)
            ...
            if not container:IsDescendantOf(workspace) then
                ...
                print("⚠️ The container was not picked up: " .. container.Name)
            end
        else
            print("⚠️ Failed to activate prompt: " .. container.Name)
        end
    else
        print("⚠️ Proximity prompt not found: " .. container.Name)
    end
...
local function teleportToContainer(container)
    ...
    print("🚀 Тteleported to container: " .. container.Name)
...
local function initialize()
    while not workspace:FindFirstChild("VFX") do
        warn("Waiting for the folder VFX...")
        task.wait(3)
    end
    ...
    print("✅ The auto-farm system has been launched!")
    print("🎯 Tracked " .. #CONTAINER_TYPES .. " types of containers")
    print("🚀 Press H to switch interface")
    print("⚡ Priority farming: Mega containers > Rare > Common")
end
